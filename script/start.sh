...
nohup java \
-Dspring.config.location=classpath:/application.properties,/home/ec2-user/app/application-$IDLE_PROFILE.properties,/home/ec2-user/app/application-variable.properties \
