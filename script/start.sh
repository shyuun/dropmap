...
REPOSITORY=/home/ec2-user/app/dropmap/
...
nohup java \
-Dspring.config.location=classpath:/application-$IDLE_PROFILE.properties,/home/ec2-user/app/application-variable.properties \
