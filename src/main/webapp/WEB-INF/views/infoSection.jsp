...
<div class="layout-container flex flex-col">
    ...
    <footer id="footerAd1" class="block w-full bg-gray-50 border-t border-gray-200">
        <div class="p-2 text-center min-h-[320px]">
            <!-- 푸터1 -->
            <ins class="adsbygoogle"
                 style="display:block"
                 data-ad-client="ca-pub-4694284708905804"
                 data-ad-slot="1968687825"
                 data-ad-format="auto"
...
<div class="layout-container flex flex-col">
    ...
    <footer id="footerAd2" class="block w-full bg-gray-50 border-t border-gray-200">
        <div class="p-2 text-center min-h-[320px]">
            <ins class="adsbygoogle"
                 style="display:block"
                 data-ad-client="ca-pub-4694284708905804"
                 data-ad-slot="5781608628"
                 data-ad-format="auto"
                 data-full-width-responsive="true"></ins>
        </div>
    </footer>
...
<div class="layout-container flex flex-col">
    ...
    <footer id="footerAd3" class="block w-full bg-gray-50 border-t border-gray-200">
        <div class="p-2 text-center min-h-[320px]">
            <!-- 푸터3 -->
            <ins class="adsbygoogle"
                 style="display:block"
                 data-ad-client="ca-pub-4694284708905804"
                 data-ad-slot="4569148047"
                 data-ad-format="auto"
                 data-full-width-responsive="true"></ins>
        </div>
    </footer>
...
<div class="layout-container flex flex-col">
    ...
    <footer id="footerAd4" class="block w-full bg-gray-50 border-t border-gray-200">
        <div class="p-2 text-center min-h-[320px]">
            <!-- 푸터4 -->
            <ins class="adsbygoogle"
                 style="display:block"
                 data-ad-client="ca-pub-4694284708905804"
                 data-ad-slot="4468526951"
                 data-ad-format="auto"
                 data-full-width-responsive="true"></ins>
        </div>
    </footer>
